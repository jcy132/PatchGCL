...
class PatchSampleF(nn.Module):
    ...
    def forward(self, feats, num_patches=64, patch_ids=None, graph=False):
        return_ids = []
        return_feats = []
        return_Nemb = []
        ...
        for feat_id, feat in enumerate(feats):
            ...
            # x_Nemb = self.l2norm(x_sample)
            if graph:
                return_Nemb.append(self.l2norm(x_sample))
        ...
        if graph:
            return return_feats, return_ids, return_Nemb
        else:
